...
export function FullWaveRectifierCurve({ width, voltage }: VoltageCurveProps) {
    ...
    useEffect(() => {
        voltageSignal.current = Math.abs(voltage);
    }, [voltage]);
    ...
    const animate = () => {
        signalWindow.current[signalIndex.current] = voltageSignal.current;
